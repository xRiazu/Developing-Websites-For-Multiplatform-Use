<section class="relatve">
  ...
  <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
    ...
    <div class="mx-auto mb-12 w-full max-w-3xl text-center md:mb-16 lg:mb-20">
      <h1 class="mb-4 text-4xl font-semibold md:text-6xl">The Local Theatre<span class="bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6390526ac2a607693620c97b_Rectangle%2010.svg')] bg-cover bg-center px-4 text-white">Dev Time</span>.</h1>
      ...
      <div class="flex justify-center">
        ...
        <a href="#" class="flex max-w-full flex-row items-center justify-center rounded-xl border border-solid border-[#1353fe] px-6 py-3 font-semibold text-[#1353fe] [box-shadow:rgb(19,_83,_254)_6px_6px]">
          ...
          <p class="text-black">View Shows & Blogs</p>
        </a>
      </div>
    </div>
    <!-- Image Div -->
