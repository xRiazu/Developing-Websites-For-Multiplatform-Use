...
<header class='flex shadow-lg py-4 px-4 sm:px-10 font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
  <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
    <a href="javascript:void(0)" class="hidden max-sm:block">The Local Theatre</a>
    ...
    <div id="collapseMenu" class='max-lg:hidden lg:!block max-lg:w-full max-lg:fixed max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50'>
      ...
      <ul class='lg:flex lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
        <li class='mb-6 hidden max-lg:block'>
          <a href="<?= ROOT_DIR ?>"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" class='w-36' /></a>
        </li>
        <li class='max-lg:border-b max-lg:py-3 px-3'>
          <a href='<?= ROOT_DIR ?>' class='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>Home</a>
        </li>
        <li class='max-lg:border-b max-lg:py-3 px-3'>
          <a href='<?= ROOT_DIR ?>blog' class='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'>Blog</a>
        </li>
        ...
        <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) : ?>
          <?php if ($_SESSION['role'] === 'admin') : ?>
            ...
            <li class='max-lg:border-b max-lg:py-3 px-3'>
              <a href='<?= ROOT_DIR ?>admin/upload-blog' class='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'>Add Blogs</a>
            </li>
