...
$blogs->execute();
$blogs->store_result();
$blogs->bind_result($BlogID, $BlogTitle, $BlogContent, $BlogStatus, $BlogCreated);
?>
...
<div class="font-sans mt-10">
      <div class="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-purple-900">
        ...
        <div class="lg:h-[480px] flex items-center">
          <img src="<?= ROOT_DIR ?>assets/images/music_production.jpg" class="w-full h-full object-cover" alt="Dining Experience" />
        </div>
      </div>
